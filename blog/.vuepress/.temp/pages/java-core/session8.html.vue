...
<h1 id="tong-ket-bai-tap-cuoi-mon-java-can-ban" tabindex="-1"><a class="header-anchor" href="#tong-ket-bai-tap-cuoi-mon-java-can-ban" aria-hidden="true">#</a> Tổng kết. Bài tập cuối môn Java căn bản</h1>
<h2 id="_1-đe-bai" tabindex="-1"><a class="header-anchor" href="#_1-đe-bai" aria-hidden="true">#</a> 1. Đề bài</h2>
</div></template>
